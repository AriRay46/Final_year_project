...
mt-1 rounded p-2 w-24' value={inputs.pricePerNight} onChange={e =>
      ...
      <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
        {Object.keys(inputs.amenities).map((amenity, index) => (<div key={index}>
      ...
      <button className='bg-blue-500 hover:bg-blue-600 active:scale-95 transition-all text-white rounded-md max-md:w-full md:h-8 px-6 py-1 text-base font-medium cursor-pointer md:ml-auto md:whitespace-nowrap'>
        Add Room
      </button>
