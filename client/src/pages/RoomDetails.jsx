    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex flex-col md:flex-row md:justify-between mt-10'>
        <div className='flex flex-col'>
          <h1 className='text-3x1 md:text-4x1 font-playfair'>Experience Luxury
            Like Never Before</h1>
          <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
            {room.amenities.map((item, index) => (
              <div key={index} className='flex items-center gap-2 px-3 py-2 rounded-1g bg-gray-100'>
      ...
      <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
        ...
        <button type='submit' className='bg-blue-500 hover:bg-blue-600 active:scale-95 transition-all text-white rounded-md max-md:w-full md:h-14 px-10 py-3 text-base font-medium cursor-pointer md:ml-auto md:whitespace-nowrap'>
...
<button className='bg-blue-500 hover:bg-blue-600 active:scale-95 transition-all text-white rounded px-6 py-2.5 mt-4 font-medium cursor-pointer'>Contact Now</button>
</div>
